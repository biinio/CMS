            ...
            action: function(promise, restoreSelection){
                ...
                modalInstance.result.then(function(result){
                    if (result) {
                        ...
                        return that.$editor().wrapSelection('insertHighlight', highlightHtml,true);
                    }
                });
                return false;
            }
            ...
            action: function(promise, restoreSelection){
                    ...
                    controller :function ($rootScope, $modalInstance) {
                        ...
                        $rootScope.getPriceListHtml = function () {
                            ...
                            for (var index = 0; index < $rootScope.pricedItems.length; index++) {
                                ...
                                switch($rootScope.pricedItems[index].currency) {
                                    case "1":
                                        currency = "$";
                                        break;
                                    case "2":
                ...
                modalInstance.result.then(function(result){
                    if (result) {
                        ...
                        return that.$editor().wrapSelection('insertPriceList', priceListHtml,true);
