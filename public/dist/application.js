...
var ApplicationConfiguration = (function() {
	...
	var applicationModuleVendorDependencies = ['ngRoute', 'ngAnimate', 'ngStorage', 'ngTouch', 'ngCookies',
		...
		'datePicker','ui.bootstrap-slider','ngDragDrop','dndLists','nvd3','ngImgCrop','color.picker','monospaced.qrcode'];
...
(function() {
    ...
    giftboardController.$inject = ['$scope', 'Organization', '$http'];

    function giftboardController($scope, Organization, $http){
        var giftboard = this;
        ...
        function init(){
            $scope.image = NO_IMAGE_PROFILE;
            $scope.organizationService = Organization;
            $scope.items = [
                    {'status':'Asignar','gifts':[{name: 'Perro'},{name: 'Oso'}]
                },
                    {'status':'Enviados','gifts':[{name: 'Gato'}]
                },
                    {'status':'Reclamados','gifts':[{name: 'Cerdo'}]
                },
                    {'status':'Entregados','gifts':[{name: 'Vaca'}]
                }
            ];
            getGiftsData();
        }
        ...
        function getGiftsData() {
            ...
            if(organizationId){
                ...
                $http.get(ApplicationConfiguration.applicationBackendURL + 'api/organizations/' + organizationId + '/dashboard')
                    .success(function (data) {
