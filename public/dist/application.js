...
(function() {
    ...
    currentCardController.$inject = ['$scope', 'Organization', 'GlobalFilters', 'Qrcode', 'Dashboard'];

    function currentCardController($scope, Organization, GlobalFilters, Qrcode, Dashboard){
        ...
        function getInitialInformation() {
            ...
            $scope.QrcodeService.getCurrentQr().then(function(data) {
